...
def halvesies(numbers):
    ...
    for number in numbers:
        half = float(number)/2
        halvesies_numbers.append(half)

    return halvesies_numbers
...
def join_strings_with_comma(words):
    ...
    thing, of course::
        ...
        'Pretzel'
    """
    # I really thought that this will work!!

    # strings_with_comma = str(words)[1:-1] 
    
    # return strings_with_comma

    words_from_list = ""
    for word in words:
        words_from_list = words_from_list + word + ", "  

    return words_from_list[:-2]
...
def duplicates(items):
    ...
    for word in items:
        if word not in items_words:
            items_words.append(word)
        elif word in items_words and word not in duplicates_words:
            duplicates_words.append(word)

    return sorted(duplicates_words)
